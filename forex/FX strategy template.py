'''
    Title: FX strategy template
    Description: This is a base set-up for FX strategies
    Asset class: FX
    Dataset: FXCM Minute
'''
import pandas as pd
...
def rebalance(context,data):
    ...
    try:
        ...
        weights = [-1.0/n]*n
        context.weights = dict(zip(context.universe,weights))
...
def compute_rollovers(context, data):
    ...
    rates_3m = short_rates.current(context,['AUD','CAD','CHF','EUR','GBP','JPY','NZD','USD'])
    carry = 0
