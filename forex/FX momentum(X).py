'''
    Title: FX_Momentum_Cross-sectional
    Description: Cross-sectional momentum strategy for FX. Among G10, pick top 2 to go 
        long and bottom 2 to go short, based on volatility-adjusted past returns. 
...
def signal_function_momentum(context, data):
    ...
    sorted_universe = sorted(momentum.items(), key=lambda x: x[1])
